...
class TextEditor:
    def __init__(self, master):
        ...
        filemenu.add_separator() #just for a horizontal rool
    ...
    def new_file(self):
        self.text.delete('1.0', END)  # Clear the text widget
    ...
    def save_file(self):
        if self.file_path:
            with open(self.file_path, 'w') as file:
                file.write(self.text.get('1.0', END))  # Write the text widget content to file
        else:
            self.save_file_as()
